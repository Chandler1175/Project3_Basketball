...
// Section:  005
// Description:  An appllication that lets the user view the stats of a basketball team
// Assistance: Youtube - CU Boulder Data Structures CSCI 227 
// 
//-----------------------------------------------------------
#include <iostream>
#include "team.h"
...
void printLogo() {
	cout << "-----------------------------------------------------\n";
	cout << "             BASKETBALL STATS FOR BASKETBALL \n";
	cout << "                  by Chandler Hamilton \n";
	cout << "-----------------------------------------------------\n";
} // printLogo()
